...
export default function ResearchPage() {
  ...
  const TABS: { id: TabId; label: string; icon: React.ReactNode; count?: number; aiOnly?: boolean }[] = [
    ...
    { id: 'topics',        label: 'Tags',          icon: <Layers    className="w-3.5 h-3.5" />, count: s?.discoveredTopics?.all.length },
    { id: 'opportunities', label: 'Keywords',      icon: <Lightbulb className="w-3.5 h-3.5" />, count: s?.searchIntelligence?.opportunities.length },
